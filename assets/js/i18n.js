(function () {
	...
	var translations = {
		fr: {
			...
			"tech.text": "EVOCTO est une agence web offshore qui combine expertise technique et efficacité opérationnelle. Nous utilisons des technologies fiables comme WordPress, PrestaShop, Laravel et Flutter pour développer des sites vitrines, des e-commerces, des projets web sur mesure et des applications mobiles. Notre approche franco-malgache facilite la communication avec les équipes françaises et internationales, avec des livrables alignés sur les standards européens.",
		...
		en: {
			...
			"tech.text": "EVOCTO is an offshore web agency combining technical expertise with operational efficiency. We use reliable technologies such as WordPress, PrestaShop, Laravel and Flutter to build showcase websites, e-commerce platforms, custom web projects and mobile applications. Our French-Malagasy approach makes communication easier for French and international teams, with deliverables aligned with European standards.",
	...
	var pageContentMap = [
		...
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .sec-title_heading", fr: "Trois formats pour avancer avec EVOCTO", en: "Three ways to move forward with OCTO" },
	...
	var documentTitleTranslations = {
		en: {
			"OCTO | Agence digitale": "EVOCTO | Digital agency",
			"OCTO | À propos": "EVOCTO | About",
			"OCTO | Services": "EVOCTO | Our services",
			"OCTO | Détails des services": "EVOCTO | Service details",
			"OCTO | Réalisations": "EVOCTO | Work",
			"OCTO | Détails des réalisations": "EVOCTO | Work details",
			"OCTO | Blog": "EVOCTO | Articles",
			"OCTO | Articles": "EVOCTO | Articles",
			"OCTO | Contact": "EVOCTO | Contact us",
			"OCTO | Conditions générales de vente": "EVOCTO | Sales Terms",
			"OCTO | Mentions légales": "EVOCTO | Legal Notice",
			"OCTO | Politique de cookies": "EVOCTO | Cookie Policy"
		}
	};
