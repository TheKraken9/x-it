(function () {
	...
	var translations = {
		fr: {
			...
			"contact.whatsappText": "Écrivez-nous sur WhatsApp au +33 7 59 56 08 96 pour obtenir une première réponse rapide.",
		...
		en: {
			...
			"contact.whatsappText": "Message us on WhatsApp at +33 7 59 56 08 96 for a quick first response.",
	...
	var pageContentMap = [
		...
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(1) strong", fr: "Appelez-nous", en: "Call us" },
		...
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(2) strong", fr: "Envoyez-nous un e-mail", en: "Send us an email" },
