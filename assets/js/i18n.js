(function () {
	...
	var storageKey = "evocto-language";
	var legacyStorageKey = "oc" + "to-language";
	var languageParam = "lang";
	var defaultLanguage = "fr";

	var translations = {
		fr: {
			"meta.title": "EVOCTO | Agence digitale",
			"nav.home": "Accueil",
			"nav.about": "À propos",
			...
			"sidebar.address": "Antananarivo, Madagascar",
			"sidebar.emailLabel": "Email",
			"sidebar.email": "contact@evocto.fr",
			"sidebar.contactLabel": "Contact",
			"sidebar.contact": "WhatsApp +33 7 59 56 08 96",
			...
			"hero.slide1.title": "Des plateformes <span>web</span> <br class='evocto-mobile-break'>pensées pour vos <br class='evocto-mobile-break'>opérations",
			"hero.slide2.eyebrow": "Design & expérience",
			"hero.slide2.title": "Des interfaces <span>claires</span> <br class='evocto-mobile-break'>pour vos utilisateurs",
			"hero.slide3.eyebrow": "Applications métier",
			"hero.slide3.title": "Des outils <span>mobiles</span> <br class='evocto-mobile-break'>fiables pour vos équipes",
			...
			"impact.eyebrow": "<div class=\"sec-title_dots\"><span></span><span></span><span></span></div>Pourquoi digitaliser<div class=\"sec-title_dots\"><span></span><span></span><span></span></div>",
			"impact.title": "Des leviers concrets pour faire grandir votre activité",
			"impact.text": "Un site, une application ou une plateforme métier doit répondre à un besoin clair : être visible, gagner du temps, automatiser, centraliser ou renforcer vos équipes.",
			"impact.label.problem": "Le constat :",
			"impact.label.module": "Le module :",
			"impact.visible.metric": "24/7",
			"impact.visible.title": "Être visible",
			"impact.visible.problem": "Sans présence en ligne, votre activité n'existe que pendant vos heures d'ouverture physique.",
			"impact.visible.module": "Un site vitrine professionnel ou une refonte de votre site actuel permet à vos clients potentiels de vous trouver, de découvrir vos services et de vous contacter à tout moment, jour et nuit, 365 jours par an.",
			"impact.visible.quote": "Votre entreprise ne dort jamais, même quand vous, si.",
			"impact.visible.link": "Création ou refonte de site vitrine",
			"impact.markets.metric": "+190",
			"impact.markets.title": "Atteindre de nouveaux marchés",
			"impact.markets.problem": "Un point de vente physique limite votre zone de chalandise à quelques kilomètres.",
			"impact.markets.module": "Internet supprime les frontières géographiques. Un site bien référencé et pensé pour l'international vous rend visible et accessible partout dans le monde.",
			"impact.markets.quote": "Votre vitrine locale devient une vitrine mondiale.",
			"impact.markets.link": "Site vitrine optimisé et stratégie digitale",
			"impact.time.metric": "40h+",
			"impact.time.title": "Gagner du temps",
			"impact.time.problem": "Les tâches répétitives comme la prise de rendez-vous, les réponses aux mêmes questions ou la saisie manuelle grignotent un temps précieux chaque semaine.",
			"impact.time.module": "Une application mobile ou un logiciel sur mesure automatise ces tâches à faible valeur ajoutée et libère du temps pour votre cœur de métier.",
			"impact.time.quote": "Et si vos outils travaillaient pour vous, pas l'inverse ?",
			"impact.time.link": "Application mobile ou logiciel métier",
			"impact.automation.metric": "10+",
			"impact.automation.title": "Automatiser",
			"impact.automation.problem": "Chaque processus manuel, facturation, relances, gestion de stock ou planning, est une source d'erreurs et de perte de temps.",
			"impact.automation.module": "Nous identifions vos processus répétitifs et développons des solutions logicielles qui les automatisent pour plus de fiabilité et de rapidité.",
			"impact.automation.quote": "Moins de tâches manuelles, plus de résultats.",
			"impact.automation.link": "Logiciels sur mesure et automatisation métier",
			"impact.dashboard.metric": "1 dashboard",
			"impact.dashboard.title": "Centraliser",
			"impact.dashboard.problem": "Jongler entre plusieurs outils comme Excel, WhatsApp, e-mails ou papier fait perdre en visibilité et en cohérence.",
			"impact.dashboard.module": "Une plateforme unique avec tableau de bord centralisé vous donne une vue d'ensemble claire de votre activité, en temps réel.",
			"impact.dashboard.quote": "Toutes vos données, un seul écran.",
			"impact.dashboard.link": "Plateforme ou dashboard sur mesure",
			"impact.team.metric": "1 à plusieurs",
			"impact.team.title": "Renforcer vos équipes",
			"impact.team.problem": "Recruter et former une équipe technique en interne est long et coûteux.",
			"impact.team.module": "Nous mettons à votre disposition un ou plusieurs développeurs dédiés à votre projet, flexibles selon vos besoins et votre budget.",
			"impact.team.quote": "Une équipe technique, sans les contraintes du recrutement.",
			"impact.team.link": "Mise à disposition de développeurs",
			...
			"offers.title": "Trois formats pour avancer avec EVOCTO",
			"offers.cmsLabel": "CMS",
			...
			"tech.text": "EVOCTO est une agence web offshore qui combine expertise technique et efficacité opérationnelle. Notre équipe travaille avec des langages, frameworks et outils fiables : JavaScript, TypeScript, PHP, Java, Python, Spring, Laravel, React, Angular, Flutter, WordPress, PrestaShop, Drupal, WooCommerce, bases de données, Docker, Kubernetes et solutions cloud. Nous développons des sites vitrines, e-commerces, projets web sur mesure et applications mobiles alignés sur les standards européens et internationaux.",
			"tech.note": "Remarque : la stack n'est jamais imposée. Nous choisissons les technologies selon vos objectifs, votre budget, votre environnement existant et la maintenabilité du projet.",
			...
			// des produits en crochets
			"homeProjects.siteTitle": "Site vitrine pour une entreprise de production de sacs en crochet",
			"homeProjects.ecommerceType": "Projet local",
			"homeProjects.ecommerceTitle": "Gestion interne d'une entreprise de vente de rideaux et décoration",
			"homeProjects.mobileType": "Application externe",
			"homeProjects.mobileTitle": "Gestion des pharmacies et des stocks pour un réseau de pharmacies",
			...
			"contact.callTitle": "Appelez-nous sur +261 38 38 380 00",
			...
			"contact.emailTitle": "Envoyez-nous un e-mail sur responsable@evocto.fr",
			"contact.emailText": "Décrivez-nous votre besoin et nous vous répondrons dans les meilleurs délais avec une solution adaptée.",
			"contact.whatsappTitle": "Contactez-nous sur WhatsApp au +33 7 59 56 08 96",
			"contact.whatsappText": "Écrivez-nous sur WhatsApp pour obtenir une première réponse rapide.",
			...
			"contact.form.subject": "Sujet du projet",
			"contact.form.message": "Décrivez votre besoin",
			"contact.form.submit": "Envoyer le message",
			"contact.form.sending": "Envoi en cours...",
			"contact.form.success": "Merci, votre message a bien été envoyé. L'équipe EVOCTO vous répondra rapidement.",
			"contact.form.error": "Le message n'a pas pu être envoyé. Vous pouvez nous écrire directement à contact@evocto.fr.",
			"contact.form.invalid": "Merci de compléter les champs obligatoires avec une adresse e-mail valide.",
			"team.eyebrow": "Notre équipe",
			"team.title": "Une équipe structurée pour <br> livrer vos projets",
			"team.info": "Une équipe complète pour cadrer, concevoir, développer, tester et maintenir vos solutions digitales.",
			"team.page.big": "Équipe",
			"team.page.title": "Équipe EVOCTO",
			"team.page.breadcrumb": "Équipe",
			"team.card1.area": "Direction & stratégie",
			"team.card1.role": "CEO & Fondateur",
			"team.card2.area": "Architecture & sécurité",
			"team.card2.role": "CTO / Architecte logiciel",
			"team.card3.area": "Pilotage projet",
			"team.card3.role": "Chef de projet digital",
			"team.card4.area": "Développement web",
			"team.card4.role": "Développeur Senior Full-Stack",
			"team.card5.area": "Design produit",
			"team.card5.role": "Lead UI/UX Designer",
			"team.card6.area": "Qualité & support",
			"team.card6.role": "Ingénieur QA & Support",
			"team.cta.eyebrow": "Prêt à renforcer votre équipe ?",
			"team.cta.title": "Parlons de vos besoins web, mobile ou logiciel.",
			"team.cta.button": "Demander un accompagnement",
			"team.detail.big": "Profils",
			"team.detail.pageTitle": "Profils EVOCTO",
			"team.detail.breadcrumb": "Profils",
			"team.detail.designation": "Équipe projet EVOCTO",
			"team.detail.title": "Les rôles clés mobilisés selon votre projet",
			"team.detail.intro1": "Chaque mission est structurée avec les bons profils : direction stratégique, pilotage technique, gestion de projet, design, développement, qualité et support.",
			"team.detail.intro2": "Selon votre besoin, nous composons une équipe légère ou dédiée pour avancer vite, garder une communication claire et livrer une solution maintenable.",
			"team.detail.info.strategyLabel": "Direction :",
			"team.detail.info.techLabel": "Technique :",
			"team.detail.info.deliveryLabel": "Delivery :",
			"team.detail.info.productionLabel": "Production :",
			"team.detail.info.designLabel": "Design :",
			"team.detail.info.qualityLabel": "Qualité :",
			"team.detail.orgTitle": "Organisation d'équipe",
			"team.detail.orgText1": "Une équipe efficace ne se limite pas au développement. Elle combine décision, architecture, coordination, expérience utilisateur, production et contrôle qualité.",
			"team.detail.orgText2": "Cette structure nous permet de garder le projet aligné avec vos objectifs, de sécuriser les choix techniques et de réduire les risques pendant la livraison.",
			"team.detail.tab.skills": "Compétences",
			"team.detail.tab.method": "Méthode",
			"team.detail.skillsText": "Architecture logicielle, développement web et mobile, UI/UX, QA, maintenance, support et accompagnement à la digitalisation.",
			"team.detail.methodText": "Cadrage, backlog, priorisation, sprints courts, points de suivi, tests, livraison progressive et documentation.",
			"team.detail.whenTitle": "Quand mobiliser ces profils ?",
			"team.detail.whenText": "Pour un site vitrine, une application mobile, une plateforme métier, un logiciel sur mesure ou une équipe dédiée, nous ajustons le niveau d'accompagnement selon le budget, le délai et la criticité du projet.",
			"team.detail.skillsTitle": "Compétences",
			"team.detail.skill1": "Pilotage stratégique",
			"team.detail.skill2": "Architecture & sécurité",
			"team.detail.skill3": "Delivery projet",
			"team.detail.contactTitle": "Parler à l'équipe",
			"team.detail.contactText": "Expliquez votre besoin et nous vous proposerons la composition d'équipe la plus adaptée.",
			"team.detail.projectPlaceholder": "Type de projet",
			"team.detail.ctaEyebrow": "Besoin d'une équipe fiable ?",
			"team.detail.ctaTitle": "Construisons la bonne combinaison de profils pour votre projet.",
			"incredible.eyebrow": "Découvrir",
			"incredible.title": "des talents engagés",
			"incredible.behind": "derrière <br>EVOCTO",
			...
			"footer.email": "contact@evocto.fr",
			"footer.phone": "WhatsApp +33 7 59 56 08 96",
			"footer.terms": "CGV",
			"footer.legal": "Mentions légales",
			"footer.cookies": "Politique de cookies",
			"footer.copyright": "EVOCTO © 2026. Tous droits réservés."
		},
		en: {
			"meta.title": "EVOCTO | Digital agency",
			"nav.home": "Home",
			"nav.about": "About",
			...
			"hero.slide1.title": "<span>Web</span> platforms <br class='evocto-mobile-break'>built for your operations",
			"hero.slide2.eyebrow": "Design & experience",
			"hero.slide2.title": "<span>Clear</span> interfaces <br class='evocto-mobile-break'>for your users",
			"hero.slide3.eyebrow": "Business applications",
			"hero.slide3.title": "Reliable <span>mobile</span> tools <br class='evocto-mobile-break'>for your teams",
			...
			"impact.eyebrow": "<div class=\"sec-title_dots\"><span></span><span></span><span></span></div>Why go digital<div class=\"sec-title_dots\"><span></span><span></span><span></span></div>",
			"impact.title": "Concrete levers to grow your business",
			"impact.text": "A website, application or business platform should answer a clear need: visibility, time savings, automation, centralized data or stronger teams.",
			"impact.label.problem": "The issue:",
			"impact.label.module": "The module:",
			"impact.visible.metric": "24/7",
			"impact.visible.title": "Be visible",
			"impact.visible.problem": "Without an online presence, your activity only exists during your physical opening hours.",
			"impact.visible.module": "A professional showcase website, or a redesign of your current site, helps potential clients find you, discover your services and contact you at any time, day or night, 365 days a year.",
			"impact.visible.quote": "Your business never sleeps, even when you do.",
			"impact.visible.link": "Showcase website creation or redesign",
			"impact.markets.metric": "+190",
			"impact.markets.title": "Reach new markets",
			"impact.markets.problem": "A physical point of sale limits your catchment area to a few kilometers.",
			"impact.markets.module": "The internet removes geographic borders. A well-optimized website designed for international visibility makes you accessible worldwide.",
			"impact.markets.quote": "Your local storefront becomes a global storefront.",
			"impact.markets.link": "Optimized website and digital visibility strategy",
			"impact.time.metric": "40h+",
			"impact.time.title": "Save time",
			"impact.time.problem": "Repetitive tasks such as appointment booking, answering the same questions or manual data entry consume valuable time every week.",
			"impact.time.module": "A mobile application or custom software automates low-value tasks and frees up time for your core business.",
			"impact.time.quote": "What if your tools worked for you, not the other way around?",
			"impact.time.link": "Mobile application or business software",
			"impact.automation.metric": "10+",
			"impact.automation.title": "Automate",
			"impact.automation.problem": "Every manual process, invoicing, follow-ups, stock management or planning, creates a risk of errors and lost time.",
			"impact.automation.module": "We identify your repetitive processes and develop software solutions that automate them for greater reliability and speed.",
			"impact.automation.quote": "Fewer manual tasks, more results.",
			"impact.automation.link": "Custom software and business automation",
			"impact.dashboard.metric": "1 dashboard",
			"impact.dashboard.title": "Centralize",
			"impact.dashboard.problem": "Switching between several tools such as Excel, WhatsApp, emails or paper reduces visibility and consistency.",
			"impact.dashboard.module": "A single platform with a centralized dashboard gives you a clear real-time overview of your business activity.",
			"impact.dashboard.quote": "All your data, on one screen.",
			"impact.dashboard.link": "Custom platform or dashboard",
			"impact.team.metric": "One to several",
			"impact.team.title": "Strengthen your teams",
			"impact.team.problem": "Recruiting and training an internal technical team is long and costly.",
			"impact.team.module": "We provide one or more dedicated developers for your project, flexible according to your needs and budget.",
			"impact.team.quote": "A technical team, without recruitment constraints.",
			"impact.team.link": "Dedicated developer support",
			...
			"offers.title": "Three ways to move forward with EVOCTO",
			"offers.cmsLabel": "CMS",
			...
			"tech.text": "EVOCTO is an offshore web agency combining technical expertise with operational efficiency. Our team works with reliable languages, frameworks and tools: JavaScript, TypeScript, PHP, Java, Python, Spring, Laravel, React, Angular, Flutter, WordPress, PrestaShop, Drupal, WooCommerce, databases, Docker, Kubernetes and cloud solutions. We build showcase websites, e-commerce platforms, custom web projects and mobile applications aligned with European and international standards.",
			"tech.note": "Note: the stack is never imposed. We choose technologies according to your goals, budget, existing environment and long-term maintainability.",
			...
			"homeProjects.siteTitle": "Showcase website for a crochet bag manufacturing company",
			"homeProjects.ecommerceType": "local project",
			"homeProjects.ecommerceTitle": "Internal management system for a curtain and home decor company",
			"homeProjects.mobileType": "External application",
			"homeProjects.mobileTitle": "Pharmacy and inventory management system for a pharmacy network",
			...
			"contact.callTitle": "Call us on +261 38 38 380 00",
			"contact.callText": "Speak directly with one of our advisors to get information or discuss your project.",
			"contact.emailTitle": "Send us an email on responsable@evocto.fr",
			"contact.emailText": "Tell us what you need and we will reply quickly with a suitable solution.",
			"contact.whatsappTitle": "Contact us on WhatsApp at +33 7 59 56 08 96",
			"contact.whatsappText": "Message us on WhatsApp for a quick first response.",
			...
			"contact.form.subject": "Project subject",
			"contact.form.message": "Describe your need",
			"contact.form.submit": "Send message",
			"contact.form.sending": "Sending...",
			"contact.form.success": "Thank you, your message has been sent. The EVOCTO team will reply soon.",
			"contact.form.error": "The message could not be sent. You can email us directly at contact@evocto.fr.",
			"contact.form.invalid": "Please complete the required fields with a valid email address.",
			"team.eyebrow": "Our team",
			"team.title": "A structured team to <br> deliver your projects",
			"team.info": "A complete team to scope, design, develop, test and maintain your digital solutions.",
			"team.page.big": "Team",
			"team.page.title": "EVOCTO Team",
			"team.page.breadcrumb": "Team",
			"team.card1.area": "Leadership & strategy",
			"team.card1.role": "CEO & Founder",
			"team.card2.area": "Architecture & security",
			"team.card2.role": "CTO / Software Architect",
			"team.card3.area": "Project delivery",
			"team.card3.role": "Digital Project Manager",
			"team.card4.area": "Web development",
			"team.card4.role": "Senior Full-Stack Developer",
			"team.card5.area": "Product design",
			"team.card5.role": "Lead UI/UX Designer",
			"team.card6.area": "Quality & support",
			"team.card6.role": "QA & Support Engineer",
			"team.cta.eyebrow": "Ready to strengthen your team?",
			"team.cta.title": "Let's discuss your web, mobile or software needs.",
			"team.cta.button": "Request support",
			"team.detail.big": "Profiles",
			"team.detail.pageTitle": "EVOCTO Profiles",
			"team.detail.breadcrumb": "Profiles",
			"team.detail.designation": "EVOCTO project team",
			"team.detail.title": "Key roles mobilized according to your project",
			"team.detail.intro1": "Each engagement is structured with the right profiles: strategic leadership, technical guidance, project management, design, development, quality and support.",
			"team.detail.intro2": "Depending on your needs, we assemble a lean or dedicated team to move fast, keep communication clear and deliver a maintainable solution.",
			"team.detail.info.strategyLabel": "Leadership:",
			"team.detail.info.techLabel": "Technical:",
			"team.detail.info.deliveryLabel": "Delivery:",
			"team.detail.info.productionLabel": "Production:",
			"team.detail.info.designLabel": "Design:",
			"team.detail.info.qualityLabel": "Quality:",
			"team.detail.orgTitle": "Team organization",
			"team.detail.orgText1": "An effective team is not limited to development. It combines decision-making, architecture, coordination, user experience, production and quality control.",
			"team.detail.orgText2": "This structure keeps the project aligned with your goals, secures technical choices and reduces risk during delivery.",
			"team.detail.tab.skills": "Skills",
			"team.detail.tab.method": "Method",
			"team.detail.skillsText": "Software architecture, web and mobile development, UI/UX, QA, maintenance, support and digitalization guidance.",
			"team.detail.methodText": "Scoping, backlog, prioritization, short sprints, follow-up meetings, testing, progressive delivery and documentation.",
			"team.detail.whenTitle": "When should these profiles be involved?",
			"team.detail.whenText": "For a showcase website, mobile app, business platform, custom software or dedicated team, we adjust the level of support according to budget, timeline and project criticality.",
			"team.detail.skillsTitle": "Skills",
			"team.detail.skill1": "Strategic steering",
			"team.detail.skill2": "Architecture & security",
			"team.detail.skill3": "Project delivery",
			"team.detail.contactTitle": "Talk to the team",
			"team.detail.contactText": "Explain your need and we will suggest the most suitable team setup.",
			"team.detail.projectPlaceholder": "Project type",
			"team.detail.ctaEyebrow": "Need a reliable team?",
			"team.detail.ctaTitle": "Let's build the right mix of profiles for your project.",
			"incredible.eyebrow": "Discover",
			"incredible.title": "committed talents",
			"incredible.behind": "behind <br>EVOCTO",
			...
			"footer.copyright": "EVOCTO © 2026. All rights reserved."
		}
	};
	...
	function storedLanguage() {
		try {
			var legacyLanguage = localStorage.getItem(legacyStorageKey);
			if (!localStorage.getItem(storageKey) && isKnownLanguage(legacyLanguage)) {
				localStorage.setItem(storageKey, legacyLanguage);
	...
	var selectorMap = [
		...
		{ selector: ".evocto-offers .sec-title_title", key: "offers.eyebrow", mode: "centeredSectionTitle" },
		{ selector: ".evocto-home-projects .sec-title_title", key: "homeProjects.eyebrow", mode: "centeredSectionTitle" },
	...
	var pageContentMap = [
		...
		{ pages: ["services.html"], selector: ".evocto-services-page .sec-title_title", fr: "Ce que nous proposons", en: "What we offer", mode: "centeredSectionTitle" },
		{ pages: ["services.html"], selector: ".evocto-services-page .sec-title_heading", fr: "Des solutions digitales concrètes pour votre activité", en: "Concrete digital solutions for your business" },
		{ pages: ["services.html"], selector: ".evocto-services-page .sec-title_text", fr: "EVOCTO conçoit, développe et maintient des outils adaptés à vos objectifs, sans vous imposer de solution standardisée.", en: "EVOCTO designs, develops and maintains tools tailored to your goals, without imposing a standardized solution." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(1) h3 a", fr: "Développement Web", en: "Web Development" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(1) p", fr: "Sites vitrines, boutiques e-commerce et plateformes web sur-mesure, rapides, sécurisées et évolutives.", en: "Showcase websites, e-commerce stores and custom web platforms that are fast, secure and scalable." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(2) h3 a", fr: "Développement Mobile", en: "Mobile Development" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(2) p", fr: "Applications iOS et Android pensées pour un besoin métier précis, de l'UX à la publication.", en: "iOS and Android apps designed for a precise business need, from UX to publication." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(3) h3 a", fr: "Logiciel sur-mesure", en: "Custom software" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(3) p", fr: "Outils internes, gestion de stock, suivi logistique et plateformes SaaS adaptés à votre façon de travailler.", en: "Internal tools, stock management, logistics tracking and SaaS platforms adapted to the way you work." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(4) h3 a", fr: "Design UI/UX & Identité visuelle", en: "UI/UX Design & Visual Identity" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(4) p", fr: "Interfaces claires, parcours intuitifs, logo, charte graphique et supports cohérents.", en: "Clear interfaces, intuitive journeys, logo design, brand guidelines and consistent assets." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(5) h3 a", fr: "Maintenance & Support", en: "Maintenance & Support" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(5) p", fr: "Mises à jour, corrections, petites évolutions et suivi technique pour garder vos outils fiables.", en: "Updates, fixes, small improvements and technical monitoring to keep your tools reliable." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(6) h3 a", fr: "Externalisation / Mise à disposition d'équipe", en: "Outsourcing / Dedicated team" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(6) p", fr: "Développeurs et designers intégrés à votre organisation, avec flexibilité, suivi et confidentialité.", en: "Developers and designers integrated into your organization, with flexibility, tracking and confidentiality." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(7) h3 a", fr: "Accompagnement à la digitalisation", en: "Digitalization support" },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-service-card:nth-child(7) p", fr: "Diagnostic, conseil, choix d'outils, mise en place progressive et accompagnement des équipes.", en: "Diagnosis, consulting, tool selection, progressive implementation and team support." },
		{ pages: ["services.html"], selector: ".evocto-services-page .evocto-link", fr: "Voir le détail", en: "View details", mode: "html", suffix: " <span class=\"fa-solid fa-arrow-right\"></span>" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .sec-title_title", fr: "Offres", en: "Offers", mode: "centeredSectionTitle" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .sec-title_heading", fr: "Trois formats pour avancer avec EVOCTO", en: "Three ways to move forward with EVOCTO" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(1) .evocto-offer-card_label, #offres .row > div:nth-child(1) .evocto-offer-card_label", fr: "CMS", en: "CMS" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(1) .evocto-offer-card h3, #offres .row > div:nth-child(1) .evocto-offer-card h3", fr: "CMS WordPress / PrestaShop / Drupal", en: "WordPress / PrestaShop / Drupal CMS" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(1) .evocto-offer-card_price, #offres .row > div:nth-child(1) .evocto-offer-card_price", fr: "60€ par jour", en: "€60 per day" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(1) li:nth-child(1), #offres .row > div:nth-child(1) li:nth-child(1)", fr: "Un chef de projet", en: "A project manager" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(1) li:nth-child(2), #offres .row > div:nth-child(1) li:nth-child(2)", fr: "Réduction progressive selon le volume apporté", en: "Progressive discount based on volume" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(1) li:nth-child(3), #offres .row > div:nth-child(1) li:nth-child(3)", fr: "Des équipes dédiées à vos projets", en: "Dedicated teams for your projects" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) .evocto-offer-card_label, #offres .row > div:nth-child(2) .evocto-offer-card_label", fr: "Régie", en: "Staffing" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) .evocto-offer-card h3, #offres .row > div:nth-child(2) .evocto-offer-card h3", fr: "Développeur Web full-stack à temps plein", en: "Full-time full-stack web developer" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) .evocto-offer-card_price, #offres .row > div:nth-child(2) .evocto-offer-card_price", fr: "850€ / développement", en: "€850 / development" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) li:nth-child(1), #offres .row > div:nth-child(2) li:nth-child(1)", fr: "Un chef de projet", en: "A project manager" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) li:nth-child(2), #offres .row > div:nth-child(2) li:nth-child(2)", fr: "8h de travail par jour avec 1h de pause", en: "8 working hours per day with a 1-hour break" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) li:nth-child(3), #offres .row > div:nth-child(2) li:nth-child(3)", fr: "Une équipe qui s'adapte à vos horaires", en: "A team that adapts to your schedule" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(2) li:nth-child(4), #offres .row > div:nth-child(2) li:nth-child(4)", fr: "Pas de contrainte de technologie", en: "No technology constraint" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(3) .evocto-offer-card_label, #offres .row > div:nth-child(3) .evocto-offer-card_label", fr: "Sur mesure", en: "Custom" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(3) .evocto-offer-card h3, #offres .row > div:nth-child(3) .evocto-offer-card h3", fr: "Développement sur mesure", en: "Custom development" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(3) .evocto-offer-card_price, #offres .row > div:nth-child(3) .evocto-offer-card_price", fr: "85€ / jour", en: "€85 / day" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(3) li:nth-child(1), #offres .row > div:nth-child(3) li:nth-child(1)", fr: "Un chef de projet", en: "A project manager" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(3) li:nth-child(2), #offres .row > div:nth-child(3) li:nth-child(2)", fr: "Réduction progressive selon le volume apporté", en: "Progressive discount based on volume" },
		{ pages: ["services.html", "service-detail.html"], selector: ".evocto-offers .row > div:nth-child(3) li:nth-child(3), #offres .row > div:nth-child(3) li:nth-child(3)", fr: "Des équipes dédiées à vos projets", en: "Dedicated teams for your projects" },
		...
		{ pages: ["project.html"], selector: ".evocto-project-page .sec-title_title", fr: "Réalisations", en: "Work", mode: "centeredSectionTitle" },
		{ pages: ["project.html"], selector: ".evocto-project-page .sec-title_heading", fr: "Des projets pensés pour des besoins concrets", en: "Projects designed for concrete needs" },
		...
		{ pages: ["blog.html"], selector: ".page-title h1", fr: "Blog EVOCTO", en: "EVOCTO Articles" },
		{ pages: ["blog.html"], selector: ".bread-crumb li:last-child", fr: "Blog", en: "Articles" },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .sec-title_title", fr: "Blog", en: "Articles", mode: "centeredSectionTitle" },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .sec-title_heading", fr: "Conseils et repères pour vos projets digitaux", en: "Guidance and benchmarks for your digital projects" },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one:nth-child(1) .news-block_one-title a", fr: "Comment structurer un projet digital efficace", en: "How to structure an effective digital project" },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one:nth-child(1) .evocto-card-text", fr: "Un projet digital réussit mieux quand les objectifs, les utilisateurs, les contraintes et les étapes de livraison sont cadrés dès le départ.", en: "A digital project succeeds more easily when goals, users, constraints and delivery stages are framed from the start." },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one:nth-child(2) .news-block_one-title a", fr: "Créer du contenu utile pour attirer les bons clients", en: "Create useful content to attract the right clients" },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one:nth-child(2) .evocto-card-text", fr: "Le contenu devient un levier commercial quand il répond aux vraies questions des clients et met en avant l'expertise de l'entreprise.", en: "Content becomes a business driver when it answers real client questions and showcases the company's expertise." },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one:nth-child(3) .news-block_one-title a", fr: "Réussir sa transformation digitale étape par étape", en: "Succeed in digital transformation step by step" },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one:nth-child(3) .evocto-card-text", fr: "La transformation digitale est plus durable quand elle avance par priorités, avec des outils adaptés et un accompagnement clair des équipes.", en: "Digital transformation is more sustainable when it moves forward by priorities, with suitable tools and clear team support." },
		{ pages: ["blog.html"], selector: ".evocto-blog-page .news-block_one-meta li:nth-child(2)", fr: "<span class=\"icon fa-solid fa-user fa-fw\"></span>Conseil", en: "<span class=\"icon fa-solid fa-user fa-fw\"></span>Consulting", mode: "html" },

		{ pages: ["contact.html"], selector: ".page-title h1", fr: "Contactez EVOCTO", en: "Contact EVOCTO" },
		{ pages: ["contact.html"], selector: ".bread-crumb li:last-child", fr: "Contact", en: "Contact us" },
		{ pages: ["contact.html"], selector: ".evocto-contact-page .sec-title_title", fr: "Contact", en: "Contact us", mode: "sectionTitle" },
		{ pages: ["contact.html"], selector: ".evocto-contact-page .sec-title_heading", fr: "Parlons de votre projet", en: "Let's talk about your project" },
		{ pages: ["contact.html"], selector: ".evocto-contact-page .evocto-rich-text p", fr: "Notre équipe d'experts est à votre écoute pour vous conseiller et vous accompagner à chaque étape de votre projet. Contactez-nous afin de bénéficier d'un accompagnement personnalisé et de solutions conçues pour répondre efficacement à vos enjeux.", en: "Our expert team is ready to listen, advise you and support you at every stage of your project. Contact us to benefit from personalized guidance and solutions designed to address your challenges effectively." },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(1) strong", fr: "Appelez-nous sur +261 38 38 380 00", en: "Call us at +261 38 38 380 00" },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(1) em", fr: "Échangez directement avec un conseiller.", en: "Speak directly with an advisor." },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(2) strong", fr: "Envoyez-nous un e-mail à responsable@evocto.fr", en: "Send us an email at responsable@evocto.fr" },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(2) em", fr: "Décrivez votre besoin et recevez une réponse adaptée.", en: "Describe your need and receive a suitable response." },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(3) strong", fr: "WhatsApp", en: "WhatsApp" },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(3) em", fr: "Écrivez-nous sur WhatsApp au +33 7 59 56 08 96.", en: "Message us on WhatsApp at +33 7 59 56 08 96." },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(4) strong", fr: "Rendez-nous visite", en: "Visit us" },
		{ pages: ["contact.html"], selector: ".evocto-contact-method:nth-child(4) em", fr: "Tananarive, Madagascar.", en: "Antananarivo, Madagascar." },
		{ pages: ["contact.html"], selector: ".evocto-contact-page .btn-style-one .text-one, .evocto-contact-page .btn-style-one .text-two", fr: "Envoyer le message", en: "Send message" },
		...
		{ pages: ["blog-detail.html"], selector: ".page-title h1", fr: "Articles EVOCTO", en: "EVOCTO Articles" },
		...
		{ pages: ["blog-detail.html"], selector: ".evocto-detail-article p:nth-of-type(2)", fr: "Chez EVOCTO, nous privilégions une approche progressive : comprendre le besoin réel, choisir les bons outils, construire une solution lisible, puis l'améliorer dans le temps avec les retours des utilisateurs.", en: "At EVOCTO, we favor a progressive approach: understand the real need, choose the right tools, build a clear solution, then improve it over time with user feedback." },
	...
	var documentTitleTranslations = {
		en: {
			"EVOCTO | Agence digitale": "EVOCTO | Digital agency",
			"EVOCTO | À propos": "EVOCTO | About",
			"EVOCTO | Services": "EVOCTO | Our services",
			"EVOCTO | Détails des services": "EVOCTO | Service details",
			"EVOCTO | Réalisations": "EVOCTO | Work",
			"EVOCTO | Détails des réalisations": "EVOCTO | Work details",
			"EVOCTO | Blog": "EVOCTO | Articles",
			"EVOCTO | Articles": "EVOCTO | Articles",
			"EVOCTO | Contact": "EVOCTO | Contact us",
			"EVOCTO | Conditions générales de vente": "EVOCTO | Sales Terms",
			"EVOCTO | Mentions légales": "EVOCTO | Legal Notice",
			"EVOCTO | Politique de cookies": "EVOCTO | Cookie Policy"
		}
	};
	...
	var autoTextTranslations = {
		en: {
			...
			"Contactez EVOCTO": "Contact EVOCTO",
			"Blog EVOCTO": "EVOCTO Blog",
			"Articles EVOCTO": "EVOCTO Articles",
			...
			"Trois formats pour avancer avec EVOCTO": "Three ways to move forward with EVOCTO",
			...
			"EVOCTO est une agence portée par une vision humaine du digital, qui vous conseille et vous soutient durablement dans vos projets.": "EVOCTO is an agency driven by a human vision of digital work, advising you and supporting your projects over the long term.",
			...
			"Chez EVOCTO, nous croyons que le numérique est un véritable levier de croissance, capable de réduire les contraintes opérationnelles et de créer de nouvelles opportunités pour les entreprises de toutes tailles.": "At EVOCTO, we believe digital technology is a true growth driver, able to reduce operational constraints and create new opportunities for companies of every size.",
			...
			"EVOCTO conçoit, développe et maintient des outils adaptés à vos objectifs, sans vous imposer de solution standardisée.": "EVOCTO designs, develops and maintains tools tailored to your goals, without imposing a standardized solution.",
			...
			"Pourquoi externaliser chez EVOCTO ?": "Why outsource with EVOCTO?",
			...
			"Chez EVOCTO, nous privilégions une approche progressive : comprendre le besoin réel, choisir les bons outils, construire une solution lisible, puis l'améliorer dans le temps avec les retours des utilisateurs.": "At EVOCTO, we favor a progressive approach: understand the real need, choose the right tools, build a clear solution, then improve it over time with user feedback.",
			...
			"Appelez-nous sur +261 38 38 380 00": "Call us at +261 38 38 380 00",
			"Échangez directement avec un conseiller.": "Speak directly with an advisor.",
			"Envoyez-nous un e-mail à responsable@evocto.fr" : "Send us an email by responsable@evocto.fr",
			"Décrivez votre besoin et recevez une réponse adaptée.": "Describe your need and receive a suitable response.",
			"WhatsApp": "WhatsApp",
			"Écrivez-nous sur WhatsApp au +33 7 59 56 08 96.": "Message us on WhatsApp at +33 7 59 56 08 96.",
			"Rendez-nous visite": "Visit us",
			"Tananarive, Madagascar.": "Antananarivo, Madagascar.",
			"Envoyer le message": "Send message",
			"Client EVOCTO": "EVOCTO client",
			...
			"EVOCTO nous a aidés à clarifier notre besoin, structurer le projet et livrer une solution web adaptée à notre façon de travailler.": "EVOCTO helped us clarify our need, structure the project and deliver a web solution adapted to the way we work.",
	...
	var autoAttributeTranslations = {
		en: {
			...
			"Chef de projet EVOCTO": "EVOCTO project manager",
			"Développeur web EVOCTO": "EVOCTO web developer",
			"Designer UI UX EVOCTO": "EVOCTO UI UX designer",
			"Ingénieur support EVOCTO": "EVOCTO support engineer",
			"Plateforme e-commerce sur-mesure": "Custom e-commerce platform",
			"Application mobile métier": "Business mobile app",
			"Outil interne de pilotage": "Internal management tool",
			"Comment structurer un projet digital efficace": "How to structure an effective digital project",
	...
	function applyTranslations(language) {
		...
		document.dispatchEvent(new CustomEvent("evocto:languagechange", {
			detail: {
				language: language
			}
		}));
