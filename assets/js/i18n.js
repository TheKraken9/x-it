(function () {
	...
	var translations = {
		fr: {
			...
			"contact.form.success": "Merci, votre message a bien été envoyé. L'équipe OCTO vous répondra rapidement.",
			"contact.form.error": "Le message n'a pas pu être envoyé. Vous pouvez nous écrire directement à contact@octo.fr.",
		...
		en: {
			...
			"contact.form.success": "Thank you, your message has been sent. The OCTO team will reply soon.",
			"contact.form.error": "The message could not be sent. You can email us directly at contact@octo.fr.",
